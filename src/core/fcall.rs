...
bitflags! {
    pub struct FileOpenMode : u32 {
        ...
        const P9_DOTL_CREATE     =   0x00000100;
        const P9_DOTL_EXCL      =    0x00000200;
        const P9_DOTL_NOCTTY    =    0x00000400;
        const P9_DOTL_TRUNC    =     0x00001000;
        const P9_DOTL_APPEND   =     0x00002000;
        const P9_DOTL_NONBLOCK =     0x00004000;
        const P9_DOTL_DSYNC    =     0x00010000;
        const P9_DOTL_FASYNC   =     0x00020000;
        const P9_DOTL_DIRECT   =     0x00040000;
        const P9_DOTL_LARGEFILE  =   0x00100000;
        const P9_DOTL_DIRECTORY  =   0x00200000;
        const P9_DOTL_NOFOLLOW  =    0x00400000;
        const P9_DOTL_NOATIME   =    0x01000000;
        const P9_DOTL_CLOEXEC  =     0x02000000;
        const P9_DOTL_SYNC    =      0x04000000;
    }
}
